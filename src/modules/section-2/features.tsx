        ...
        <section className="w-full min-h-screen  py-8" id="about">
          <div className="w-full h-max flex flex-col justify-center items-center  ">
            ...
            <h1 className="text-slate-400 font-semibold text-md text-center mt-10">
              The Pewsey Dental Practice was established in 2001 and offers a
              wide range of dental care all within the NHS, Private and
              Insurance schemes (Denplan). Our dedicated team of experienced
              dentists and friendly staff is committed to delivering exceptional
              care tailored to your unique needs. Pewsey Dental Surgery is more
              than a dental destination; it’s a cornerstone of your local oral
              healthcare.
            </h1>
          </div>
          <div className="flex flex-wrap flex-col md:flex-row   py-16 gap-2 gap-y-16 justify-between">
            ...
            <div className="w-full md:max-w-[45%] lg:max-w-[30%] flex flex-col gap-4">
              ...
              <div className="w-full gap-2 flex flex-col">
                ...
                <p className="text-slate-400 font-medium text-md">
                  ...
                  precise, efficient, and effective treatments.
                </p>
              </div>
            </div>
            <div className="w-full md:max-w-[45%] lg:max-w-[30%] flex flex-col gap-4">
            ...
            <div className="w-full md:max-w-[45%] lg:max-w-[30%] flex flex-col gap-4">
              ...
              <div className="w-full gap-2 flex flex-col">
                ...
                <p className="text-slate-400 font-medium text-md">
                  Our dedicated team combines expertise with compassion,
